...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "UPDATE pegawai SET nama_pegawai='$nama_pegawai', tgl_lahir='$tgl_lahir', id_jabatan=$id_jabatan WHERE id_pegawai=$id_pegawai";
  $result = mysqli_query($con, $sql);

  if ($result) {
    $_SESSION['success'] = 'Data berhasil dirubah';
    header("location: index.php");
  } else {
    header("location");
  }
